  ...
  <tr> 
    ...
    <td valign="top"> 
      <table width="96%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
        <tr> 
          <td valign="middle" width="468" height="45" align="center"> 
            <p align="left">&nbsp;&nbsp;<%=path%> Архив</p>
          </td>
        </tr>
        <tr> 
          <td height="56" valign="middle" align="center" width="468">
            <%if (tpm<7) {%>
            ...
            <table width="100%" border="0" bordercolor="#FFFFFF" align="center" cellspacing="3" class="base_text">
              <tr valign="top" bordercolor="#FFFFFF"> 
                ...
                <td bordercolor="#FFFFFF"> 
                  <p><b><a href="<%=url%>"><%=pname%></a></b><br>
                    [<%=pdat%>] <%=digest%> [<a href="<%=url%>">далее</a>] 
                    <%if (usok) {%>
                    <br>
              ...
              <tr> 
                <td> 
                  <p align="CENTER"><font face="Arial, Helvetica, sans-serif" size="2"><b> 
                    ...
                    страница</a> | <a href="archive.asp?hid=<%=hid%>&pg=<%=pg+1%>"></a> 
                    <%
  } 
  if (pos>lpag*(1+pg)) {
  %>
...
%>
              <img src="images/link.gif" align="absmiddle"><a href="<%=url%>" class="web" target="_blank"><%=pname%></a><br>
            <%
	Records.MoveNext()
} 
Records.Close()
