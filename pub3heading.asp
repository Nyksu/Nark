...
while (hdd>0) {
	...
	hadr=TextFormData(Records("URL").Value,"pub3heading.asp")
	if (hdd==hid) {
		path=nm+"   "+path
      ...
      <table width="100%" border="1" cellspacing="0" cellpadding="5" class="base_text" bordercolor="#135086">
        <tr> 
          <td bgcolor="#FFFFFF" bordercolor="#FFFFFF"> 
            ...
            <li>
              <a class="globalnav" href="index.asp"><p><b>В начало</b></p></a> 
                <%
isnews=1
...
while (!Records.EOF)
{
	...
	url=TextFormData(Records("URL").Value,"pub3heading.asp")
	url+="?hid="+hdd
	Records.MoveNext()
%>
...
%>
            <li>
              <a class=globalnav href="message.asp"><p><b>E-mail</b></a> 
...
imgname=""
	...
	hadr=TextFormData(recs("URL").Value,"pub3heading.asp")
	path="<a href=\""+hadr+"?hid="+hdd+"\">"+nm+"</a> &gt; "+path
      ...
      <table width="95%" border="1" cellspacing="0" cellpadding="5" class="base_text" bordercolor="#135086" height="300">
        <tr> 
          <td valign="top" bgcolor="#FFFFFF" bordercolor="#FFFFFF"> 
            ...
            </font><font size="1"> |<b> </b><a href="delpub3heading.asp?hid=<%=hid%>"><font face="Arial, Helvetica, sans-serif" color="#006600"><b>Удалить 
...
%>
            ...
            <table width="100%" border="0" cellspacing="6" cellpadding="0">
              <tr> <%}%>
                ...
                <td width="33%" valign="top" bgcolor="#FEFEFC"> 
                  <%if (imgname != "") {%>
                  <img src="<%=imgname%>" > 
                  <%}else{%>
                  &nbsp; 
              ...
              <tr> 
                <td> 
                  <p align="CENTER"><font face="Arial, Helvetica, sans-serif" size="2"><b> 
                    <%if (pg>0) {%>
                    <a href="pub3heading.asp?hid=<%=hid%>&pg=<%=pg-1%>">Предыдущая 
                    страница раздела</a> 
                    <%
  } 
  if (pos>lpag*(1+pg)) {
  %>
                    <a href="pub3heading.asp?hid=<%=hid%>&pg=<%=pg+1%>">Следующая 
